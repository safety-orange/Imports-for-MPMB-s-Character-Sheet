...
AddSubClass("bard", "college of eloquence", {
	...
	features: {
		...
		"subclassfeature3.1": {
			...
			source : [["T", 30], ["MOT", 28]],
			minlevel : 3,
			description: "\nAs a Bonus Action, I can expend and roll a Bardic Inspiration Die to have a creature I can see within 60 ft subtract the result from the next save it makes before my next turn starts.",
			action: [["bonus action", ""]],
		},
		"subclassfeature6": {
